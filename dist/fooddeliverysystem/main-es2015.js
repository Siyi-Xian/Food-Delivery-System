...
let ChatfeatureComponent = class ChatfeatureComponent {
    ...
    addUser() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('/chat/users', { username })
            .then(() => {
...
let CustomerRecommendationsComponent = class CustomerRecommendationsComponent {
    constructor(http, cookie) {
        this.http = http;
        this.cookie = cookie;
    }
...
CustomerRecommendationsComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: ngx_cookie_service__WEBPACK_IMPORTED_MODULE_3__["CookieService"] }
];
...
let DeliverychatfeatureComponent = class DeliverychatfeatureComponent {
    constructor(cookie) {
        this.cookie = cookie;
        this.title = 'Angular Chatroom';
        this.messages = [];
    ...
    addUser() {
        const username = this.cookie.get("name");
        console.log({ username });
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('/chat/users', { username })
            .then(() => {
            const tokenProvider = new _pusher_chatkit_client__WEBPACK_IMPORTED_MODULE_3___default.a.TokenProvider({
                url: '/chat/authenticate'
            });
            const chatManager = new _pusher_chatkit_client__WEBPACK_IMPORTED_MODULE_3___default.a.ChatManager({
                instanceLocator: 'v1:us1:dcb29a79-09aa-41bb-a0ec-fdb33220fb0a',
                userId: username,
                tokenProvider
            });
...
DeliverychatfeatureComponent.ctorParameters = () => [
    { type: ngx_cookie_service__WEBPACK_IMPORTED_MODULE_2__["CookieService"] }
];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("body{\r\n  background-image: url('background1.jpeg');\r\n  background-repeat: no-repeat;\r\n  background-position: center center;\r\n  background-size: cover;\r\n  \r\n \r\n  min-height: 2000px;\r\n  margin-left: auto;\r\n  background-origin: content-box;\r\n  background-attachment: fixed;\r\n  -webkit-background-size: cover;\r\n  -moz-background-size: cover;\r\n  \r\n  -o-background-size: cover;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
let DeliveryloginComponent = class DeliveryloginComponent {
    constructor(loginService, formBuilder, cookie, router, http) {
    ...
    recover() {
        ...
        this.http.post(url, data).subscribe((res) => this.forgot_message = "Password resetted", (err) => console.log(err));
        console.log(data);
    }
...
let DeliveryprivatechatComponent = class DeliveryprivatechatComponent {
    constructor(route, cookie, router) {
        this.route = route;
        this.cookie = cookie;
        this.router = router;
        this.userId = '';
    ...
    addUser() {
        const { userId } = this;
        axios__WEBPACK_IMPORTED_MODULE_5___default.a.post('/privatechat/users', { userId })
            .then(() => {
            const tokenProvider = new _pusher_chatkit_client__WEBPACK_IMPORTED_MODULE_4___default.a.TokenProvider({
...
DeliveryprivatechatComponent.ctorParameters = () => [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("body{\r\n  background-image: url('background1.jpeg');\r\n  background-repeat: no-repeat;\r\n  background-position: center center;\r\n  background-size: cover;\r\n  \r\n  min-height: 2000px;\r\n  margin-left: auto;\r\n  background-origin: content-box;\r\n  background-attachment: fixed;\r\n  -webkit-background-size: cover;\r\n  -moz-background-size: cover;\r\n  \r\n  -o-background-size: cover;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("body{\r\n  background-image: url('background1.jpeg');\r\n  background-repeat: no-repeat;\r\n  background-position: center center;\r\n  background-size: cover;\r\n \r\n \r\n  \r\n  min-height: 2000px;\r\n  margin-left: auto;\r\n  background-origin: content-box;\r\n  background-attachment: fixed;\r\n  -webkit-background-size: cover;\r\n  -moz-background-size: cover;\r\n  \r\n  -o-background-size: cover;\r\n}\r\n\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
let PrivatechatComponent = class PrivatechatComponent {
    constructor(route, cookie, router) {
        this.route = route;
        this.cookie = cookie;
        this.router = router;
...
PrivatechatComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: ngx_cookie_service__WEBPACK_IMPORTED_MODULE_3__["CookieService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".window {\r\n  float: top;\r\n  position: absolute;\r\n  left: 50%;\r\n  top: 50%;\r\n\r\n  height: 600px;\r\n  margin-top: -300px;\r\n\r\n  width: 360px;\r\n  margin-left: -160px;\r\n\r\n  border: 3px solid gray;\r\n  border-radius: 15px;\r\n\r\n  text-align: center;\r\n  background-color: #ffe0b2;\r\n}\r\n\r\n.regist-form {\r\n  width: 100%;\r\n  padding-left: 10%;\r\n  padding-right: 10%;\r\n  text-align: left;\r\n  font-size: 16px;\r\n\r\n  padding-bottom: 10px;\r\n  border-bottom-color: gray;\r\n  border-bottom-style: solid;\r\n  border-bottom-width: 2px;\r\n}\r\n\r\n.regist-form p {\r\n  margin-top: 5px;\r\n}\r\n\r\n.regist-form input {\r\n  width: 100%;\r\n}\r\n\r\n.regist-form button {\r\n  width: 100%;\r\n  padding-top: 2px;\r\n  height: 30px;\r\n}\r\n\r\nbody{\r\n  background-image: url('background1.jpeg');\r\n  background-repeat: no-repeat;\r\n  background-position: center center;\r\n  background-size: cover;\r\n  \r\n  min-height: 2000px;\r\n  margin-left: auto;\r\n  background-origin: content-box;\r\n  background-attachment: fixed;\r\n  -webkit-background-size: cover;\r\n  -moz-background-size: cover;\r\n  \r\n  -o-background-size: cover;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
let RestaurantmenuComponent = class RestaurantmenuComponent {
    constructor(loginService, formBuilder, cookie, http, router) {
        this.loginService = loginService;
        this.formBuilder = formBuilder;
        this.cookie = cookie;
        this.http = http;
    ...
    onSubmit(menu) {
        ...
        this.http.post('/restaurant/menu', formData).subscribe((res) => this.router.navigate(['/restaurantviewmenu']), (err) => console.log(err));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".window {\r\n  float: top;\r\n  position: absolute;\r\n  left: 50%;\r\n  top: 50%;\r\n\r\n  height: 570px;\r\n  margin-top: -260px;\r\n\r\n  width: 400px;\r\n  margin-left: -200px;\r\n\r\n  border: 3px solid gray;\r\n  border-radius: 15px;\r\n\r\n  text-align: center;\r\n  background-color: #ffe0b2;\r\n}\r\n\r\n.regist-form {\r\n  width: 100%;\r\n  padding-left: 10%;\r\n  padding-right: 10%;\r\n  text-align: left;\r\n  font-size: 16px;\r\n}\r\n\r\n.regist-form p {\r\n  margin-top: 5px;\r\n}\r\n\r\n.regist-form input {\r\n  width: 100%;\r\n}\r\n\r\n.regist-form button {\r\n  width: 100%;\r\n  padding-top: 2px;\r\n  height: 30px;\r\n}\r\n\r\nbody{\r\n  background-image: url('background1.jpeg');\r\n  background-repeat: no-repeat;\r\n  background-position: center center;\r\n  background-size: cover;\r\n  \r\n  min-height: 2000px;\r\n  margin-left: auto;\r\n  background-origin: content-box;\r\n  background-attachment: fixed;\r\n  -webkit-background-size: cover;\r\n  -moz-background-size: cover;\r\n  \r\n  -o-background-size: cover;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".window {\r\n  float: top;\r\n  position: absolute;\r\n  left: 50%;\r\n  top: 50%;\r\n\r\n  height: 520px;\r\n  margin-top: -250px;\r\n\r\n  width: 360px;\r\n  margin-left: -160px;\r\n\r\n  border: 3px solid gray;\r\n  border-radius: 15px;\r\n\r\n  text-align: center;\r\n  background-color: #ffe0b2;\r\n}\r\n\r\n.login-form {\r\n  width: 100%;\r\n  padding-left: 10%;\r\n  padding-right: 10%;\r\n  text-align: left;\r\n  font-size: 16px;\r\n\r\n  padding-bottom: 10px;\r\n  border-bottom-color: gray;\r\n  border-bottom-style: solid;\r\n  border-bottom-width: 2px;\r\n}\r\n\r\n.login-form p {\r\n  margin-top: 25px;\r\n}\r\n\r\n.login-form input {\r\n  width: 100%;\r\n}\r\n\r\n.login-form button {\r\n  width: 100%;\r\n  padding-top: 2px;\r\n  height: 30px;\r\n}\r\n\r\nbody{\r\n  background-image: url('background1.jpeg');\r\n  background-repeat: no-repeat;\r\n  background-position: center center;\r\n  background-size: cover;\r\n  \r\n  min-height: 2000px;\r\n  margin-left: auto;\r\n  background-origin: content-box;\r\n  background-attachment: fixed;\r\n  -webkit-background-size: cover;\r\n  -moz-background-size: cover;\r\n  \r\n  -o-background-size: cover;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
