...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<html>\r\n<head>\r\n  <title>\r\n    public dashboard\r\n  </title>\r\n  <!-- Bootstrap CDN scripts -->\r\n  <link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/css/bootstrap.min.css\">\r\n  <link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css\">\r\n  <link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/bootstrap-social/5.1.1/bootstrap-social.min.css\">\r\n  <script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js\"></script>\r\n  <script src=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js\"></script>\r\n  <script src=\"public.component.css\"></script>\r\n  <script src=\"../../styles.css\"></script>\r\n<!--  <script src=\"../backgroup-image.css\"></script>-->\r\n</head>\r\n<body>\r\n<app-logindropdown></app-logindropdown>\r\n\r\n<div class=\"container\">\r\n  <!-- <div class=\"container\">\r\n    <h3>Welcome to Food-O-Holics</h3>\r\n    <p style=\"font-size: 18px\">Search for restaurants below</p>\r\n  </div>\r\n  <br> -->\r\n  <div class=\"search-container\">\r\n    <form action=\"get\" [formGroup]=\"userSearchForm\" (ngSubmit)=\"onSubmit(userSearchForm.value)\">\r\n      <div class=\"row\">\r\n        <div class=\"col-md-2 col-md-offset-2\">\r\n          <div class=\"input-group\">\r\n            <input type=\"text\" placeholder=\"Restaurant Name\" formControlName=\"restaurant_name\">\r\n            <div class=\"fa fa-microphone\" (click) = \"voiceSearchName()\">\r\n            \r\n            </div>\r\n          </div>\r\n          \r\n        </div>\r\n        <div class=\"col-md-2\">\r\n          <div class=\"input-group\">\r\n            <input type=\"text\" placeholder=\"Location\" formControlName=\"location\">\r\n            <div class=\"fa fa-microphone\" (click) = \"voiceSearchLocation()\">\r\n            \r\n            </div>\r\n          </div>\r\n          \r\n        </div>\r\n        <div class=\"col-md-2\">\r\n          <div class=\"input-group\">\r\n            <input type=\"text\" placeholder=\"Category\" formControlName=\"food_category\">\r\n            <div class=\"fa fa-microphone\" (click) = \"voiceSearchCategory()\">\r\n            \r\n            </div>\r\n          </div>\r\n        </div>\r\n        <div class=\"col-md-2\">\r\n          <button class=\"btn btn-primary\" type=\"submit\"><i class=\"fa fa-search\"></i></button>\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </div>\r\n  <hr>\r\n</div>\r\n\r\n<div #result>\r\n  <div *ngIf=\"results\">\r\n    <div class=\"container\">\r\n      <div class=\"row\">\r\n        <div class=\"col-md-4 col-md-offset-1\">\r\n          <h4> Searching Result: </h4>\r\n        </div>\r\n        <div class=\"col-md-2 col-md-offset-4\">\r\n          <div class=\"dropdown\">\r\n            <button class=\"btn dropdown-toggle\" data-toggle=\"dropdown\" type=\"button\" aria-haspopup=\"true\"\r\n                    aria-expanded=\"false\">\r\n              <span class=\"glyphicon glyphicon-th-list\"></span>\r\n              Sort By\r\n            </button>\r\n            <ul class=\"dropdown-menu\">\r\n              <li><a class=\"dropdown-item\" (click)=\"updateToRatings()\">Ratings</a></li>\r\n              <!-- <li><a class=\"dropdown-item\" (click)=\"updateToLocation()\">Location</a></li>\r\n              <li><a class=\"dropdown-item\" (click)=\"updateToResName()\">Restaurant Name</a></li>\r\n              <li><a class=\"dropdown-item\" (click)=\"updateToFoodCat()\">Restaurant Category</a></li> -->\r\n            </ul>\r\n          </div>\r\n        </div>\r\n      </div>\r\n      <div class=\"container\" style=\"margin-left: 0; margin-right: 20px\">\r\n        <ul *ngFor=\"let result of results\">\r\n\r\n            <!-- <div class=\"card mb-3\" style=\"max-width: 540px;\">\r\n                <div class=\"row no-gutters\">\r\n                  <div class=\"col-md-4\">\r\n                    <img [src]=\"'/restaurant_images/'+result.res_image\" class=\"card-img\" alt=\"...\">\r\n                  </div>\r\n                  <div class=\"col-md-8\">\r\n                    <div class=\"card-body\">\r\n                      <h5 class=\"card-title\"><a [routerLink]=\"['/login']\" >{{result.name | titlecase}}</a></h5>\r\n                      <p class=\"card-text\">{{result.description}}</p>\r\n                      <p class=\"card-text\"><small class=\"text-muted\"><strong> Food Category: </strong>{{result.food_category | titlecase}}</small></p>\r\n                      <p class=\"card-text\"><small class=\"text-muted\"><strong> Address: </strong><a\r\n                        href=\"http://maps.google.com/?q={{result.street1.replace(' ', '+')}}\">{{result.street1 | titlecase}}, {{result.street2 | titlecase}}</a></small></p>\r\n                      <p class=\"card-text\"><small class=\"text-muted\"><strong> City: </strong><a\r\n                        href=\"http://maps.google.com/?q={{result.location.replace(' ', '+')}}\">{{result.location | titlecase}}</a></small></p>\r\n                      <p class=\"card-text\"><small class=\"text-muted\"><strong> State: </strong>{{result.state | titlecase}}</small></p>\r\n                      <p class=\"card-text\"><small class=\"text-muted\"><strong> Zip Code: </strong>{{result.zip_code}}</small></p>\r\n                      <p class=\"card-text\"><small class=\"text-muted\"><strong> Food Category: </strong>{{result.food_category | titlecase}}</small></p>\r\n                      <p class=\"card-text\"><small class=\"text-muted\"><strong> Ratings: </strong>{{result.ratings/result.num_ratings}}</small></p>\r\n                      <p class=\"card-text\"><small class=\"text-muted\"><strong> Working Hours: </strong>{{result.working_hours | titlecase}}</small></p>\r\n\r\n                    \r\n                    \r\n                    </div>\r\n                  </div>\r\n                </div>\r\n            </div> -->\r\n\r\n          <div class=\"row\">\r\n            <div class=\"col-md-5\">\r\n              <img [src]=\"'/restaurant_images/'+result.res_image\" alt=\"\">\r\n            </div>\r\n            <div class=\"col-md-7\">\r\n               \r\n              <h3><a [routerLink]=\"['/login']\" >{{result.name | titlecase}}</a></h3>\r\n              <li><strong> Food Category: </strong>{{result.food_category | titlecase}}</li>\r\n              <li><strong> Address: </strong> <a\r\n                href=\"http://maps.google.com/?q={{result.street1.replace(' ', '+')}}\">{{result.street1 | titlecase}}, {{result.street2 | titlecase}}</a>\r\n              </li>\r\n              <li><strong> City: </strong> <a\r\n                href=\"http://maps.google.com/?q={{result.location.replace(' ', '+')}}\">{{result.location | titlecase}}</a>\r\n              </li>\r\n              <li><strong> State: </strong>{{result.state | titlecase}}</li>\r\n              <li><strong> Zip Code: </strong>{{result.zip_code}}</li>\r\n              <li><strong> Working Hours: </strong>{{result.working_hours | titlecase}}</li>\r\n              <li><strong> Contact: </strong>{{result.contact | titlecase}}</li>\r\n              <li><strong> Ratings: </strong>{{result.ratings/result.num_ratings | number:'1.1-2'}}</li>\r\n              <li><strong> Description: </strong>{{result.description | titlecase}}</li>\r\n            </div>\r\n          </div>\r\n          <hr>\r\n        </ul>\r\n      </div>\r\n    </div>\r\n\r\n  </div>\r\n</div>\r\n\r\n</body>\r\n</html>\r\n\r\n\r\n\r\n\r\n");
...
let ChatfeatureComponent = class ChatfeatureComponent {
    ...
    addUser() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('http://localhost:8080/chat/users', { username })
            .then(() => {
...
let DeliverychatfeatureComponent = class DeliverychatfeatureComponent {
    ...
    addUser() {
        const username = this.cookie.get("name");
        console.log({ username });
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('http://localhost:8080/chat/users', { username })
            .then(() => {
